...
(function(){
  ...
  var CSS = ''
    ...
    + '#admin-sec-consumo .cns-row .tr{flex:1;background:#16213e;border-radius:4px;height:15px;overflow:hidden;}'
    + '#admin-sec-consumo .cns-row .fi{height:100%;background:#c0392b;}'
